...
<body style="height:100vh;max-height:100vh;">
	...
	<main class="d-flex m-0 justify-content-between position-relative align-items-center">
		...
		<section class="main position-absolute" style="left:25%;top:10%;" >
			<h1 class="h3 text-success">User Register</h1>
		        <form action="userRegisterServlet" method="post" class="card-body form">
		            ...
		            <div class="input-group d-flex justify-content-between align-items-center "><button type="submit" class="btn btn-success w-100">Add</button></div>
		        </form>
